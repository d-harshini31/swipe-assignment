...
5. Access the application through the provided URL in your browser.
       ...
       ![Create Invoice](ScreenShots/Edit Invoice.png)
       ![View Invoice](ScreenShots/View Invoice.png)
       ![Invoice Dowmload](ScreenShots/Invoice Download.png)
       ![List Invoice](ScreenShots/List Invoice.png)
